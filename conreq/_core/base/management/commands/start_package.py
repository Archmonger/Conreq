...
DEV_PACKAGES_DIR: Path = getattr(settings, "DEV_PACKAGES_DIR")
...
class Command(TemplateCommand):
    ...
    def handle(self, package_name: str, **options: dict[str, Any]):  # type: ignore
        ...
        print(
            f"Successfully created new app package in '{DEV_PACKAGES_DIR / package_name}'."
        )
