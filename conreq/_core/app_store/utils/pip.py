...
from .command_line import CommandlineCaller, clean_ansi
from .platform import CLOSE_FDS
from .strings import to_unicode
...
class PipCaller(CommandlineCaller):
    ...
    def clean_install_command(
        cls, args, pip_version, virtual_env, use_user, force_user
    ):
